    ...
    <div className="w-[90%] m-auto py-5 mb-5">
      <div className="w-full relative">
        ...
        <div className="flex items-center">
          ...
          <h5 className="text-[22px] pl-3 mt-2 line-through opacity-80 ">
            {courseData?.estimatedPrice}$
          </h5>

          <h4 className="text-[22px] pl-5 pt-4">
        ...
        <div className="flex items-center">
          ...
          <div
            className={`${styles.button} !w-[180px] ml-4 my-3 font-Poppins cursor-pointer`}
          >
            Apply
          </div>
        </div>
      ...
      <div className="w-full">
        ...
        {courseData?.benefits?.map((item: any, index: number) => (
          <div className="flex 800px:items-center py-2" key={index}>

      ...
      >
        ...
        {openSidebar && (
          <div
            ...
            id="screen"
          >
            <div className="w-[50%] fixed z-[999999999] h-screen bg-white dark:bg-slate-900  top-0 right-0">
              <HiOutlineMenuAlt3
                size={25}
                className="cursor-pointer dark:text-white text-black ml-[85%] absolute mt-11"
